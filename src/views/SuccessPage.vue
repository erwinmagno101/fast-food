...
<template>
  <ion-page>
    <ion-content class="ion-padding">
      <div class="flex flex-col gap-y-5 items-center h-full">
        <div class="relative w-fit mb-25 scale-230 mx-auto mt-28">
          <div
        ...
        <div class="text-3xl font-bold pt-5">Order Received!</div>
        <div class="text-sm text-gray-500 text-center px-2">
          Your order <span class="text-red-600">No. 19049585</span> has
          successfully take and now being processe. Kindly wait for our
